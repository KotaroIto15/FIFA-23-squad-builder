...
const FourThreeThree = ({showSearch, setShowSearch, setIndex, players, map}) => {
    ...
    return (
        ...
        >
            <div id = "st_wg" className="formation-row">
                <Player showSearch = {showSearch} setShowSearch = {setShowSearch} setIndex = {setIndex} position = {map("LW", 11)} players = {players} />
                <Player showSearch = {showSearch} setShowSearch = {setShowSearch} setIndex = {setIndex} position = {map("ST", 9)} players = {players}/>
                <Player showSearch = {showSearch} setShowSearch = {setShowSearch} setIndex = {setIndex} position = {map("RW", 7)} players = {players}/>
            </div>
            ...
            <div id = "cm" className="formation-row">
                ...
                <Player showSearch = {showSearch} setShowSearch = {setShowSearch} setIndex = {setIndex} position = {map("RCM", 10)} players = {players}/>
            </div>

            <div id = "dm" className="formation-row">
                <Player showSearch = {showSearch} setShowSearch = {setShowSearch} setIndex = {setIndex} position = {map("CDM", 6)} players = {players}/>
            </div>
